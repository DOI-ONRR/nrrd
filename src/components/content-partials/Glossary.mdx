...
- name: "Effective Royalty Rate"
  definition: "Calculated by dividing the reported royalty values less allowances by the reported sales value per [OIG Report 2021-CR-042 June 2023](https://www.doioig.gov/reports/inspection-evaluation/us-department-interior-does-not-analyze-effective-royalty-rates)."
  categories:
    - ""
...
- name: "Royalty Value Less Allowances (RVLA)"
  definition: "Calculated by subtracting allowances (transportation, processing) from royalty value. RVLA = RVPA – [ Allowances * Royalty Rate]"
  categories: 
    - ""
- name: "Royalty Value Prior to Allowances (RVPA)"
  definition: "Calculated by multiplying sales value by royalty rate. RVPA = Volume * Unit Value * Royalty Rate."
  categories:
    - ""
- name: "Sales Value"
  definition: "The total value of the sale in U.S. dollars."
  categories: 
    - ""
- name: "Sales Volume"
  definition: "The volume of the mineral/resource sold."
  categories: 
    - ""
- name: "Sales Year"
  definition: "Sales transactions that took place in a given federal fiscal or calendar year. It does not include adjusted or corrected transactions for sales from previous years. Because ONRR processes royalty transactions daily, the sales year data constantly changes. For this reason, ONRR publishes sales year datasets with an as-of date showing when the information was current."
  categories:
    - ""
- name: "Sequestration"
...
- name: "Tons - Equivalent"
  ...
  categories:
    - "Units and Measurements"
- name: "Trust Land"
  definition: "Land for which the federal government holds title to the land but holds it for the beneficial interests of an Indian tribe or an individual of Indian or Alaska Native ancestry."
  categories:
    - "Land and Ownership"
