...
- name: "Land and Water Conservation Fund (LWCF)"
  ...
  categories:
    - "Disbursement"
- name: "Land Category"
  definition: "Distinguishes between data collected onshore and offshore within NRRD datasets."
  tags:
   - "Land Category"
  categories:
    - "Revenue"
    ...
    - "Disbursement"
- name: "Land Class"
  definition: "Distinguishes federal lands and waters from Native American lands within NRRD datasets."
  tags:
    - "Land Class"
  categories:
    - "Revenue"
    ...
    - "Disbursement"
- name: "Land Type"
  definition: "Combines land class and land category within NRRD's Query Data tool."
  tags:
   - "Land Type"
  categories:
    - "Revenue"
