...
- name: "Land and Water Conservation Fund (LWCF)"
  ...
  categories:
    - "Disbursement"
- name: "Land Category"
  definition: "Distinguishes between data collected onshore and offshore within ONRR datasets."
  tags:
   - "Land Category"
  categories:
    - "Revenue"
    ...
    - "Disbursement"
- name: "Land Class"
  definition: "Distinguishes federal lands and waters from Native American lands within ONRR datasets."
  tags:
    - "Land Class"
  categories:
    - "Revenue"
