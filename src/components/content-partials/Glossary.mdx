...
- name: "Effective Royalty Rate"
  definition: "Calculated by dividing the reported royalty values less allowances by the reported sales value per OIG Report 2021-CR-042 June 2023."
  categories:
    - "Federal Sales"
...
- name: "Royalty Value Prior to Allowances (RVPA)"
  ...
  categories:
    - "Federal Sales"
- name: "Sales Value"
  definition: "The value of a commodity when sales volume is multiplied by price."
  categories: 
    - "Federal Sales"
- name: "Sales Volume"
...
- name: "Unit Value"
 definition: "The price of each unit of production sold."
 categories: 
    - "Federal Sales"
