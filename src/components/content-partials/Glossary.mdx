...
- name: "Kilowatt Hour (kWh)"
  ...
  categories:
    - "Units and Measurements"
- name: "Land and Water Conservation Fund (LCWF)"
...
- name: "Location Not Published"
 ...
 categories:
    ...
    - "Production"
     - "Disbursement"
- name: "Long Ton"
  definition: "Also known as “imperial ton” or “displacement ton". It is 2,240 pounds, compared to a conventional ton (or “short ton”), which is 2,000 pounds."
  categories:
    - "Production and Commodities"
...
- name: "Public Domain Lands"
  ...
  categories:
    - "Land and Ownership"
- name: "Reclamation"
  definition: "The process of restoring the land from any affects of extracting natural resources. In most cases, this means a condition equal to that which existed before the land was disturbed. This includes surface contouring, equipment removal, well plugging, and revegetation."
  tags:
    - 'reclaim'
    - 'reclaiming'
  categories:
