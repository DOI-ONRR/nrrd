...
- name: "Not Tied to Commodity"
  definition: "Some revenue do not directly result from the production of a commodity. Revenue types associated with "not tied to a commodity" include civil penalties and inspection fees."
  tags:
