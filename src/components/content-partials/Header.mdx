<Box mt={2} mb={0} pb={0} borderBottom={2} color='secondary.main' height={{ 'sm': 85, 'md': 125 }} style={{ background: 'white', zIndex: 300, position: 'relative' }}>
  <Container maxWidth="lg">
    <Grid container>
      <Grid item xs={8} sm={4}>
        <Link href='/' linkType='Header'><NrrdLogoImg style={{ maxHeight: 130 }} /></Link>
      </Grid>
      <Hidden smDown>
        <Grid item sm={8}>
