...
const disbursementTypeDescriptions = [
  ...
  'Provides matching grants to states and local governments to buy and develop public outdoor recreation areas across the 50 states. How this fund works',
  ...
  'Helps preserve U.S. historical and archaeological sites and cultural heritage through grants to state and tribal historic preservation offices. How this fund works'
]
...
const NationwideDisbursementSummary = props => {
  ...
  if (data) {
    ...
    xGroups['Fiscal year'] = nationwideSummaryData.map((row, i) => console.log('row map: ', row))
  }
