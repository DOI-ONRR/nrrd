...
const DISBURSEMENTS_QUERY = gql`
  query FiscalDisbursements($year: Int!, $period: String!, $state: [String!]) {
...
export default props => {
  ...
  const { loading, error, data } = useQuery(DISBURSEMENTS_QUERY, {
  ...
  return (
    (dataType === CONSTANTS.DISBURSEMENTS) ? <>{children}</> : null
  )
}
