    ...
    <Container className={classes.root} maxWidth={false} component="section">
      <Container maxWidth="lg">
          ...
          <Typography variant="body1">
              In our latest release on October 25, 2019, we made the following changes:
          </Typography>
          ...
          <List component="ul" aria-label="whats new list">
            ...
            <ListItem component="li">
              ...
              <ListItemText>
                Added <Link to="/blog">blog post about designing for accessibility and inclusion</Link>
              </ListItemText>
            </ListItem>
          </List>
          <Typography variant="body1">
            Review our <a href="https://github.com/ONRR/doi-extractives-data/releases">full release details</a>.
          </Typography>
        </Container>
    </Container>
  )
