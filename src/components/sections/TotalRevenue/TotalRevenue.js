...
const TotalRevenue = props => {
  const data = [
    { X1: [{ Y1: 11, Y2: 13, Y3: 18, Y4: 20, Y5: 24, Y6: 25, Y7: 27 }] },
    { X2: [{ Y1: 10, Y2: 14, Y3: 16, Y4: 26, Y5: 24, Y6: 25, Y7: 27 }] },
    { X3: [{ Y1: 11, Y2: 16, Y3: 18, Y4: 22, Y5: 24, Y6: 25, Y7: 27 }] },
    { X4: [{ Y1: 14, Y2: 16, Y3: 20, Y4: 24, Y5: 24, Y6: 25, Y7: 27 }] },
    { X5: [{ Y1: 10, Y2: 12, Y3: 15, Y4: 22, Y5: 24, Y6: 25, Y7: 27 }] },
    { X6: [{ Y1: 13, Y2: 16, Y3: 19, Y4: 25, Y5: 24, Y6: 25, Y7: 27 }] }
  ]
