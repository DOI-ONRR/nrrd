...
const MapToolbarRevenueCommoditySelect = ({ dataFilterKey, data, defaultSelected, helperText, label, selectType, disabled }) => {
...
export default MapToolbarRevenueCommoditySelect

MapToolbarRevenueCommoditySelect.propTypes = {
  /**
