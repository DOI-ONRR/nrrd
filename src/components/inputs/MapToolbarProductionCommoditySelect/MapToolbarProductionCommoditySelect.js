...
const MapToolbarProductionCommoditySelect = ({ dataFilterKey, data, defaultSelected, helperText, label, selectType, disabled }) => {
...
export default MapToolbarProductionCommoditySelect

MapToolbarProductionCommoditySelect.propTypes = {
  /**
