...
const StackedBarChart = (props) => {
	...
	let chart= new D3StackedBarChart(elemRef.current,  data);
...
class D3StackedBarChart {
	...
	try {
	    ...
	    let maxExtentGroup = self.svg.append('g').attr('class', 'maxExtent')
	...
	} catch(e) { console.warning("Error in addMaxExtent", e) }
    }
	...
	if (this.groups) {
	    ...
	    let groupLines = this.svg.append('g').attr('class', 'stacked-bar-chart-groups')
