  ...
  addChart (props) {
    ...
    this.svg.append('g')
      ...
      .on('touchstart', function (d) {
        d3.event.preventDefault(); toggleSelectedBar(this, d, props.barSelectedCallback)
      })
      .on('mouseenter', function (d) {
        toggleHoveredBar(d, props.barHoveredCallback, true)
      })
      .on('mouseleave', function (d) {
        toggleHoveredBar(d, props.barHoveredCallback, false)
      })
      .selectAll('g')
      .data(d => {
