...
This data is available from January 2003 through the most recently available month, which is usually 3-4 months prior to the current month. The historical dataset contains data from January 2003 through December 2012 and is not updated. The dataset starting with January 2012 is updated monthly.
<br />
...
<Link linkType="DownloadCsv" href="/downloads/OGOR-B/OGORBcsv.csv">
  Production Disposition Volumes, January 2013 - January 2023
</Link>
