...
[Calendar year production (Excel, 631 KB)](/downloads/production/calendar_year_production.xlsx)
[Calendar year production (csv, 835 KB)](/downloads/csv/production/calendar_year_production.csv)
...
[Fiscal year production (Excel, 409 KB)](/downloads/production/fiscal_year_production.xlsx)
[Fiscal year production (csv, 528 KB)](/downloads/csv/production/fiscal_year_production.csv)
