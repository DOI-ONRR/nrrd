...
<br />
We offer revenue data files for both calendar year and fiscal year. The calendar year data set is for years 2003-2024, and the fiscal year data set is for years 2004-2025. They are all <GlossaryTerm>accounting year</GlossaryTerm> data. The data contains the same fields as the monthly download files.
<br />
