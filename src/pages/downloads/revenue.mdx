...
<br />
We offer revenue data files for both calendar year and fiscal year. The calendar year data set is for years 2003-2022, and the fiscal year data set is for years 2004-2022. They are all <GlossaryTerm>accounting year</GlossaryTerm> data. The data contains the same fields as the monthly download files.
<br /><br />
...
These datasets include natural resource revenues for U.S. federal lands, federal waters, and Native American lands. It does not include privately-owned lands or U.S. state lands.
<br />
Federal revenue data is available by location. Native American data is only available at the national level to protect private and personally identifiable information.
<br />
The datasets include data tracked and managed by the Department of the Interior’s Office of Natural Resources Revenue (ONRR).
<br /><br />
