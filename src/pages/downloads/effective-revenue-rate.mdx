...
## Download data:
  ...
  Calendar year effective royalty rates(csv)

  Calendar year effective royalty rates(xlsx)

## Scope

The Office of Inspector General (OIG) recommended that The Department of the Interior's Office of Natural Resources Revenue (ONRR) calculates the effective royalty rate for federal oil and gas leases. To meet the OIG’s recommendation, ONRR collects the data from the Sales and Royalty Remittance Report, Form ONRR-2014, which contains information on royalties due based on sales or use of the oil and gas production.
<br />
...
The effective royalty rate dataset is updated annually. 
