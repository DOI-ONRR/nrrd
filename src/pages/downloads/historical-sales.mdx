...
<DownloadDataFile linkType="DownloadCsv"  dataSet="historical_sales_ONRR2014.csv">
  Historical From ONRR-2014 sales data 1984-2025
</DownloadDataFile>

<DownloadDataFile linkType="DownloadXls"  dataSet="historical_sales_ONRR2014.xlsx">
  Historical From ONRR-2014 sales data 1984-2025
</DownloadDataFile>  

Download historical Form ONRR-4430 sales data:

<DownloadDataFile linkType="DownloadCsv"  dataSet="historical_sales_ONRR4430.csv">
  Historical From ONRR-4430 sales data 2001-2025
</DownloadDataFile>
...
Product codes define the product and commodity on Form ONRR-2014 and Form ONRR-4430. See <Link href='/downloads/historical-sales/#product-code-tables' linkType='default'>product code tables</Link> below for the full list of products.

## Data dictionary

### Fields and definitions

**Sales Year:** TThis dataset is sales year data reported on a calendar year basis. 
<br />
...
**Product:** Products are listed individually but may also fall into like categories. See <Link href='/downloads/historical-sales/#product-code-tables' linkType='default'>product code tables</Link> for the full list of products.
<br />
