...
Product codes define the product and commodity on Form ONRR-2014 and Form ONRR-4430. See <Link href="#product-code-tables">product code tables</Link> below for the full list of products.
...
**Product:** Products are listed individually but may also fall into like categories. See <Link href="#product-code-tables">product code tables</Link> below for the full list of products.
<br />
