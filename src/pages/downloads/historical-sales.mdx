...
# Historical sales for oil, gas, and solids

These datasets contain historical sales data reported on [Form ONRR-2014<OpenInNewIcon style={{ fontSize: 20 }} />](https://onrr.gov/reporting/revenue?tabs=forms) and [Form ONRR-4430<OpenInNewIcon style={{ fontSize: 20 }} />](https://onrr.gov/reporting/solids?tabs=forms).
<br />
