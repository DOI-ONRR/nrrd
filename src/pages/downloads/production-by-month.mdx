...
includeToc: true
path: /downloads/production-by-month
layout: downloads
...
View production data by month:
<br />
[View in Query Data](/query-data/?dataType=Revenue&period=Monthly&monthly=2020,2021,2022,2023,2024,2025&groupBy=stateOffshoreName)
