...
[Disbursements by month (Excel, 480 KB)](/downloads/disbursements/monthly_disbursements.xlsx)
[Disbursements by month (csv, 783 KB)](/downloads/csv/disbursements/monthly_disbursements.csv)
...
_Commodity_ The commodity that generated the revenue. For oil and gas, the commodity listed depends on the phase of production. Since it's unknown whether a lease will produce oil, gas, or both, the two commodities are combined in the bonus and rent phases and listed as "Oil or Gas (pre-production)."
