...
These datasets represent a snapshot of the data as of July 2026 and will not be updated. Values may differ from similar Office of Natural Resources Revenue (ONRR) reported sales datasets that are updated annually.
<br /> 
