...
<Link linkType="DownloadCsv" href="/downloads/usgs-reported-sales/usgs_national_reported_sales_ONRR2014csv.csv">
Historical Form ONRR-2014 national-level sales data 1984 – 2025
</Link>
...
<br /> 
The national-level rollup datasets summarize the same Form ONRR-2014 and Form ONRR-4430 sales data by calendar year at the national level. They are intended for users who need annual national totals rather than transaction-level detail.
## Data publication

These datasets represent a snapshot of the data as of August 2025, but was pulled July 2026. This data will not be updated. Values may differ from similar Office of Natural Resources Revenue (ONRR) reported sales datasets that are updated annually.
<br /> 
