...
# Reported sales for oil, gas, and solids: supporting USGS historical data digitization
...
These datasets represent a snapshot of the data as of [date], and will not be updated. Values may differ from similar Office of Narueal Resources Revenu (ONRR) reported sales datasets that are updated annually.
<br /> 
