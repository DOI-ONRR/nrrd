...
These datasets contain historical sales data reported on [Form ONRR-2014<OpenInNewIcon style={{ fontSize: 20 }} />](https://onrr.gov/reporting/revenue?tabs=forms) and [Form ONRR-4430<OpenInNewIcon style={{ fontSize: 20 }} />](https://onrr.gov/reporting/solids?tabs=forms) for federal lands, federal waters, and Native American lands.
<br />
...
These datasets represent a snapshot of the data as of September 19, 2025 and will not be updated. Values may differ from similar Office of Narueal Resources Revenu (ONRR) reported sales datasets that are updated annually.
<br /> 
