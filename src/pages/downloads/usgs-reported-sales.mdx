...
<br />
The data is divided into 4 separate downloadable datasets:
  ...
  3.  Historical Form ONRR-2014 sales data from 1984 – 2025, rolled up to the national level on an annual basis
  4.  Historical Form ONRR-4430 sales data from 2001 – 2025, rolled up to the national level on an annual basis

In addition to the detailed datasets, national-level annual rollups are available for users who want summarized totals rather than transaction-level detail. These rollup datasets contain the same underlying data as their detailed counterparts, aggregated to the national level by calendar year.
...
Download historical Form ONRR-2014 sales data, rolled up to the national level:

<Link linkType="DownloadXls" href="/downloads/usgs-reported-sales/usgs_national_reported_sales_ONRR2014.xlsx">
Historical Form ONRR-2014 national-level sales data 1984 – 2025
</Link>

Historical Form ONRR-2014 national-level sales data 1984 – 2025
<Link linkType="DownloadXls" href="/downloads/usgs-reported-sales/usgs_national_reported_sales_ONRR2014csv.csv">
</Link>

Download historical Form ONRR-4430 sales data, rolled up to the national level:

<Link linkType="DownloadXls" href="/downloads/usgs-reported-sales/usgs_national_reported_sales_ONRR4430.xlsx">
Historical Form ONRR-4430 national-level sales data 2001 – 2025
</Link>

<Link linkType="DownloadCsv" href="/downloads/usgs-reported-sales/usgs_national_reported_sales_ONRR4430csv.csv">
Historical Form ONRR-4430 national-level sales data 2001 – 2025
</Link>
...
The national-level rollup datasets summarize the same Form ONRR-2014 and Form ONRR-4430 sales data by calendar year at the national level, rather than by individual lease, land category, or state. They are intended for users who need annual national totals rather than transaction-level detail.
## Data publication
...
### What is the difference between the detailed datasets and the national-level rollup datasets?

The detailed datasets (Form ONRR-2014 and Form ONRR-4430) report sales data at the transaction level, including land category, state, commodity, and product. The national-level rollup datasets contain the same sales data aggregated to a single national total per commodity/product per calendar year. Use the national rollup datasets for a simplified view of national annual totals.
