...
We offer revenue by month for January 2003 through the most recently completed month. The data includes federal offshore and onshore revenue, along with revenue from Native American lands. The data is further broken down by revenue type (e.g., bonuses, rents, and royalties) and commodity.


Download monthly revenue:

[Monthly revenue, 1/2003-12/2020 (Excel, 2.8 MB)](/downloads/revenue/monthly_revenue.xlsx)
[Monthly revenue, 1/2003-12/2020 (csv, 5.4 MB)](/downloads/csv/revenue/monthly_revenue.csv)
...
<br/>
We offer revenue data files for both calendar year and fiscal year. The calendar year datasets is for years 2003-2020, and the fiscal year data set is for years 2003-2020. They are all <GlossaryTerm>accounting year</GlossaryTerm> data. The data contains the same fields as the monthly download files.
<br/>
...
Download calendar year data (2003-2020):

[Calendar year revenue (Excel, 2.8 MB)](/downloads/revenue/calendar_year_revenue.xlsx)
[Calendar year revenue (csv, 5.4 MB)](/downloads/csv/revenue/calendar_year_revenue.csv)

Download fiscal year data (2003-2020):

[Fiscal year revenue (Excel, 3.5 MB)](/downloads/revenue/fiscal_year_revenue.xlsx)
[Fiscal year revenue (csv, 5.3 MB)](/downloads/csv/revenue/fiscal_year_revenue.csv)
## Scope
...
### Why is there a Gas value, an Oil value and an Oil or Gas value?

“Oil or Gas” is the commodity category used for offshore oil and gas rents and bonuses. At the time of lease sale, it isn’t known whether a lease will produce oil, gas or both oil and gas. After a lease starts producing a commodity (or commodities), the lease owner starts paying royalties. These can then be associated with either oil or gas. Hence, rent and bonus lines of data will be associated with an “Oil or Gas” commodity type, while royalty lines of data will be associated with either “Oil” or “Gas” commodity types.
...
=======
_Date_
*_Month_The month the revenue was collected by ONRR.
*_Calendar year_ is the period between January 1 and December 31 for a given year.
*_Fiscal year_ The year the revenue was generated. The federal fiscal year runs from October 1 of the prior year through September 30 of the year being described. For example, Fiscal Year 2018 is between October 1, 2017,  and September 30, 2018.
>>>>>>> Stashed changes
