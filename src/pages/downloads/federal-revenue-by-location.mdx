...
We offer revenue data files for both calendar year and fiscal year. The calendar year datasets is for years 2003-2018, and the fiscal year data set is for years 2003-2019. They are all <GlossaryTerm>accounting year</GlossaryTerm> data.

Download calendar year data (2003-2018):

- <DownloadExcelLink to="/downloads/revenue/calendar_year_revenue.xlsx">Calendar year revenue (Excel, 2.8 MB)</DownloadExcelLink>
- <DownloadCsvLink to="/downloads/csv/revenue/calendar_year_revenue.csv">Calendar year revenue (csv, 5.4 MB)</DownloadCsvLink>

Download fiscal year data (2003-2019):

- <DownloadExcelLink to="/downloads/revenue/fiscal_year_revenue.xlsx">Fiscal year revenue (Excel, 3.4 MB)</DownloadExcelLink>
- <DownloadCsvLink to="/downloads/csv/revenue/fiscal_year_revenue.csv">Fiscal year revenue (csv, 5.2 MB)</DownloadCsvLink>
