...
We offer revenue data files for both calendar year and fiscal year. The calendar year datasets is for years 2003-2019, and the fiscal year data set is for years 2003-2020. They are all <GlossaryTerm>accounting year</GlossaryTerm> data.
