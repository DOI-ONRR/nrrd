...
and production/commodity information.
...
This dataset offers revenue by calendar year from 1982 through 2002. The data includes federal offshore and onshore revenue.
 The data is further broken down by location, lease type, revenue type (i.e., bonuses, rents, and royalties) and commodity information.
<p class="downloads-download_links-intro">Download historical revenue data:
  <ul class="downloads-download_links list-unstyled">
    <li><excel-link to="/downloads/historical_revenue_CY 1982-2002.xlsx">Historical Revenue (Excel, 127 KB)</excel-link></li>
    <li><csv-link to="/downloads/historical_revenuecsv_CY 1982-2002.csv">Hisrotical Revenue (csv, 180 KB)</csv-link></li>
  </ul>
</p>
