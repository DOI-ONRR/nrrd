...
These datasets contain historical sales data reported for royalty and non-royalty bearing transactions on Form ONRR-2014 and Form ONRR-4430 for federal lands, federal waters, and Native American lands. The data is divided into 2 separate downloadable datasets:
- Historical Form ONRR-2014 sales data from 1984 – 2025, including oil, gas, and solids products
- Historical Form ONRR-4430 sales data from 2001 – 2025, containing only solid products from leases associated with a mine

[Downloads and documentation](/downloads/historical-sales/)
