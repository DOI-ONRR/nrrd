...
Download fiscal year disbursements data:
...
View fiscal year disbursements data:
- [View in query data](/query-data/?dataType=Disbursements&period=Fiscal%20Year)  
- [View in explore data](/explore/?dataType=Disbursements&location=NF%2CNA&mapLevel=State&offshoreRegions=false&period=Fiscal%20Year)
...
* **GOMESA-Offshore:** The Gulf of Mexico Energy Security Act (GOMESA) (Gulf of America) of 2006 specifies that 50% of revenues from certain Gulf of America leases be directed to the U.S. Treasury. 37.5% of revenue from certain leases in the Gulf of America are shared with Alabama, Louisiana, Mississippi, and Texas.
