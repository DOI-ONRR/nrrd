...
Download data:
<DownloadDataFile linkType="DownloadCsv"  dataSet="monthly_disbursements" >
  Monthly disbursements
</DownloadDataFile>

<DownloadDataFile linkType="DownloadCsv"  dataSet="fiscal_year_disbursements" >
  Fiscal year disbursements
</DownloadDataFile>
<DownloadDataFile linkType="DownloadXls"  dataSet="all_disbursements" >
...
[Fiscal year disbursements (Excel, 90 KB)](/downloads/disbursements/disbursements.xlsx)
[Fiscal year disbursements (csv, 97 KB)](/downloads/csv/disbursements/disbursements.csv)
