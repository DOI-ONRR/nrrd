...
### What are production codes? 

Production codes define the product or commodity on Form ONRR-2014. This dataset does not include all production codes reported on all Form ONRR-2014s. This dataset only includes production codes related to the product and byproducts of oil, gas, and NGLs.
<br />
Below are the production codes included in the dataset.
<br />

<FederalSalesProductionCodesTable />
