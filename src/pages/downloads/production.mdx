...
[Fiscal year production (Excel, 585 KB)](/downloads/production/fiscal_year_production.xlsx)
[Fiscal year production (csv, 854 KB)](/downloads/csv/production/fiscal_year_production.csv)
...
ONRR <GlossaryTerm>withheld</GlossaryTerm> some solids production information out of an abundance of caution to ensure that there were no violations of the Trade Secrets Act.
