...
- [View calendar year production in explore data](https://revenuedata.doi.gov/explore/?dataType=Production&location=NF%2CNA&mapLevel=State&offshoreRegions=false&period=Calendar%20Year&year=2024)
- [View fiscal year production in query data](/query-data/?dataType=Production&period=Fiscal%20Year&groupBy=stateOffshoreName)
- [View fiscal year production in explore data](/explore/?dataType=Production&location=NF%2CNA&mapLevel=State&offshoreRegions=false&period=Fiscal%20Year&year=2024)
