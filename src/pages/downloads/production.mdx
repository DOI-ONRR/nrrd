...
- [View in Calendar Year Production in Query Data](/query-data/?dataType=Production&period=Calendar%20Year&groupBy=stateOffshoreName)
- [View in Calendar Year Production in Explore Data](https://revenuedata.doi.gov/explore/?dataType=Production&location=NF%2CNA&mapLevel=State&offshoreRegions=false&period=Calendar%20Year&year=2024)
- [View in Fiscal Year Year Production in Query Data](/query-data/?dataType=Production&period=Fiscal%20Year&groupBy=stateOffshoreName)
- [View in Fiscal Year Production in Explore Data](/explore/?dataType=Production&location=NF%2CNA&mapLevel=State&offshoreRegions=false&period=Fiscal%20Year&year=2024)
