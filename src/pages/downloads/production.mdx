...
**Land Class**
  * **Federal:** 
  <a
    class="link--external"
    rel="noreferrer"
    href="https://fas.org/sgp/crs/misc/R42346.pdf"
    >Federal lands (PDF)</a
  >
  are owned by or under the jurisdiction of the federal government. Federal lands include: public domain lands, acquired lands, military acquired lands, and the [Outer Continental Shelf](https://www.boem.gov/OCS-Lands-Act-History/).
