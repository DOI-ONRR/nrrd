...
The dataset currently include data tracked and managed by the Department of the Interior’s Office of Natural Resources Revenue (ONRR).The production data for Oil and Gas is collected on Form ONRR-4054-B (Oil and Gas Operations Report, Part B). Solid mineral production is collected on Form ONRR-4430 (Solid Minerals Production and Royalty Report).  Geothermal sales volumes are obtained from the Form ONRR-2014 (Report of Sales and Royalty Remittance).
