...
[Calendar year production (Excel, 579 KB)](/downloads/production/calendar_year_production.xlsx)
[Calendar year production (csv, 843 KB)](/downloads/csv/production/calendar_year_production.csv)

### Fiscal yearDownload calendar year data (2003-2019):
