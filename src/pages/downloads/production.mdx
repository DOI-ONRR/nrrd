...
Download data:
<DownloadDataFile linkType="DownloadCsv"  dataSet="monthly_production" >
  Monthly production
</DownloadDataFile>
<DownloadDataFile linkType="DownloadCsv"  dataSet="calendar_year_production" >
  Calendar year production
</DownloadDataFile>
<DownloadDataFile linkType="DownloadCsv"  dataSet="fiscal_year_production" >
  Fiscal year production
</DownloadDataFile>

<DownloadDataFile linkType="DownloadXls"  dataSet="all_production" >
...
[Calendar year production (Excel, 530 KB)](/downloads/production/calendar_year_production.xlsx)
[Calendar year production (csv, 854 KB)](/downloads/csv/production/calendar_year_production.csv)

Download fiscal year data (2003-2020):

[Fiscal year production (Excel, 597 KB)](/downloads/production/fiscal_year_production.xlsx)
[Fiscal year production (csv, 901 KB)](/downloads/csv/production/fiscal_year_production.csv)
...
_Product_ Products are listed individually but may also fall into like categories.
  ...
  * _Gold and Silver Products_ (tons) include: Gold Ore
  * _Gypsum_ (tons)
