...
Download production data by year:
...
View production data by year:
- [View calendar year production in query data](/query-data/?dataType=Production&period=Calendar%20Year&groupBy=stateOffshoreName)
- [View calendar year production in explore data](/explore/?dataType=Production&location=NF%2CNA&mapLevel=State&offshoreRegions=false&period=Calendar%20Year)
- [View fiscal year production in query data](/query-data/?dataType=Production&period=Fiscal%20Year&groupBy=stateOffshoreName)
- [View fiscal year production in explore data](/explore/?dataType=Production&location=NF%2CNA&mapLevel=State&offshoreRegions=false&period=Fiscal%20Year)
...
<br />
Both federal and mixed exploratory data are in download data (at the top of this page). Only federal data is shown in [query](/query-data/?dataType=Production&period=Calendar%20Year&groupBy=stateOffshoreName) and [explore](/explore/?dataType=Production&period=Calendar+Year&mapLevel=State&offshoreRegions=false&location=NF%2CNA&year=2024).
...
**Product:** Products are listed individually but may also fall into like categories.
  ...
  * **Geothermal - Direct Use** (millions of pounds)
