...
Both federal and mixed exploratory data are in [download data](/downloads/production/) (at the top of this page). Only federal data is shown in [query](/query-data/?dataType=Production&period=Calendar%20Year&groupBy=stateOffshoreName) and [explore](/explore/?dataType=Production&period=Calendar+Year&mapLevel=State&offshoreRegions=false&location=NF%2CNA&year=2024).
