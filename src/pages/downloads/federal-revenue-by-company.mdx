...
includeToc: true
path: /downloads/federal-revenue-by-company
layout: downloads
...
Download federal revenue by company data:

<DownloadDataFile linkType="DownloadXls" dataSet="federal_revenue_by_company.xlsx">
  Federal revenue by company, corporate crosswalk, and data dictionary
</DownloadDataFile>
...
View federal revenue by company data:
- [View in query data](/query-data/?dataType=Federal%20revenue%20by%20company&period=Calendar%20Year&groupBy=revenueType)
- [View in explore data](/explore/?dataType=Revenue&location=NF%2CNA&mapLevel=State&offshoreRegions=false&period=Calendar%20Year)
...
### What is a corporate crosswalk?

The corporate crosswalk, located within the Excel download file, provides a listing of corporate parent companies to their subsidiaries. The "payor name" refers to the entity that submits revenue payments. Within the dataset, “company name” refers to this payor name. The "corporate name" identifies the overarching parent company that may own multiple payor names (subsidiaries).
<br /> 

The corporate crosswalk is updated annually with the calendar year data. ONRR does not have a reporting vehicle to track real-time corporate family relationships. We research the best publicly available information yearly to determine the corporate name. This dataset is for informational purposes only and should not be used for legal purposes. Users assume all risk when referencing this dataset.
