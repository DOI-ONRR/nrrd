...
This dataset provides natural resource revenue data by company for calendar years 2013-2021. It includes revenues by production phase and commodity for companies extracting natural resources on federal lands and waters. It does not include company revenue from Native American lands or privately owned lands.
<br />
