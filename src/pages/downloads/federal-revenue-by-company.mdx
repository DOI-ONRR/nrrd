...
This dataset provides natural resource revenue data by company for calendar years 2013-2022. It includes revenues by production phase and commodity for companies extracting natural resources on federal lands and waters. It does not include company revenue from Native American lands or privately owned lands.
<br />
...
* **Hardrock**
* **Hot Springs**
* **Locatable Minerals** (see below)
* **Mineral Materials** (see below)
* **MLRS Minings Claims** (see below)
* **N/A**
* **Oil**
* **Oil & Gas**
* **Oil Shale**
...
**MLRS Mining Claims:** The BLM maintains the [Mineral and Land Records System (MLRS)](https://www.blm.gov/services/land-records/mlrs), which is an online platform containing mineral and land records transactions. [Mining claim](https://www.blm.gov/programs/energy-and-minerals/mining-and-minerals/locatable-minerals/mining-claims) information from MLRS contains revenue data (permit fees) from companies mining locatable minerals on BLM lands.