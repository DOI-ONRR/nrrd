...
The Outer Continental Shelf Lands Act (OCSLA) of 1953 grants the Secretary of the Department of the Interior (DOI) the authority to manage offshore energy resources. OCSAL also authorizes DOI to develop regulations to carry out that authority. Within DOI, three agencies within DOI work toward that goal: BOEM, BSEE, and ONRR. These agencies work together to manage, regulate, and collect revenue from leased acres across the <GlossaryTerm>Outer Continental Shelf</GlossaryTerm> (OCS).
...
Offshore oil and gas is managed and regulated by the [Bureau of Ocean Energy Management](http://www.boem.gov/) (BOEM) and the [Bureau of Safety and Environmental Enforcement](http://www.bsee.gov/) (BSEE).
