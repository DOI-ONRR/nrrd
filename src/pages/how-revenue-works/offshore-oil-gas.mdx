...
energy resources. This Act also authorizes DOI to develop regulations to carry out that authority. Three agencies within DOI work toward that goal.  Those agencies are BOEM, BSEE, and ONRR. They work together to manage,
regulate, and collect revenue from leased acres across the <GlossaryTerm>Outer Continental Shelf</GlossaryTerm> (OCS).
...
<br />
BOEM creates an <GlossaryTerm>Environmental Impact Statement</GlossaryTerm> to implement the program. The public may comment on the Environmental Impact Statement and the proposed leasing program. BOEM submits public comments for the program and plan to Congress and the President.
...
At the close of an operation, the lease holder or operator must return the ocean and seafloor to its pre-lease condition. Under the OCSLA regulations, the lease holder is required to submit a Decommissioning Plan to BSEE for approval. This plan must be submitted two years before the termination of the lease. To meet NEPA obligations, BOEM prepares a site-specific Environmental Assessment for each removal application on behalf of BSEE.
<br />
...
- [Resource Evaluation Glossary](https://www.boem.gov/oil-gas-energy/resource-evaluation)
