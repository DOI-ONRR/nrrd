...
<Table class="article_table">
  ...
  <TableBody>
    <TableRow>
      ...
      <TableCell><strong>12.5%</strong> of production value in royalties<br />
      <strong>$0.28</strong> per ton Abandoned Mine Land Fee
      </TableCell>
    </TableRow>
    <TableRow>
      <TableCell>Sub-surface</TableCell>
      <TableCell><strong>Bonus</strong></TableCell>
      <TableCell><strong>$3</strong> annual rent per acre</TableCell>
      <TableCell><strong>8%</strong> of production value in royalties<br />
...
<Table class="article_table">
  ...
  <TableBody>
    ...
    <TableRow>
      ...
      <TableCell><strong>$415</strong> application fee</TableCell>
      <TableCell><strong>$1</strong> annual rent per acre for 10 years<br />
