...
In general, companies pay <GlossaryTerm>bonuses</GlossaryTerm>, <GlossaryTerm>rents</GlossaryTerm>, <GlossaryTerm>royalties</GlossaryTerm>, or fees and penalties (if incurred) to <GlossaryTerm>ONRR</GlossaryTerm>, and in some cases bonuses and rents to the Bureau of Land Management. Royalties, a percentage of the sales value of extracted resources, make up most of the revenue paid to DOI.
...
#### <IconHardrockImg /> Hardrock minerals
...
#### <IconRenewablesImg /> Solar and wind energy
