...
The federal government collects the revenue. Next, it passes through a series of budgetary gateways before funding public services and community development. These gateways are described below. You can [explore disbursement data here](/explore?dataType=Disbursements).
