...
<br />
This overview is based on the <Link href="https://onrr.gov/about/interagency?tabs=standard-operating-procedures-sops">Onshore Energy and Mineral Lease Management Interagency Standard Operating Procedures </Link>.
