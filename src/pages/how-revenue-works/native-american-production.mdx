...
OSMRE lists which tribes have their own regulatory programs and Abandoned Mine Land Reclamation programs. OSMRE [provides links to their regulatory oversight documents <OpenInNewIcon style={{ fontSize: 20 }} />](https://www.odocs.osmre.gov/). Currently, the Crow Tribe, Hopi Tribe, and Navajo Nation have their own regulatory programs.
<br />
