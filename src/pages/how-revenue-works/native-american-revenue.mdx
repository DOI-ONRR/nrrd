...
<Table aria-label="Collecting revenue from production" size="small">
  ...
  <TableBody>
    <TableRow>
      ...
      <TableCell>BIA bills, collects, and accounts for rental on a least prior to BLM notice of first production.</TableCell>
      <TableCell>After production, ONRR collects, accounts for, and deposits rentals, royalties, and compliance-based collections. BIA collects other collections, such as payment for surface damages.</TableCell>
    </TableRow>
    <TableRow>
      <TableCell>Solid minerals</TableCell>
      <TableCell>BIA bills, collects, and accounts for bonuses.</TableCell>
      <TableCell>BIA bills, collects, and accounts for rental prior to production.</TableCell>
      <TableCell>BIA bills, collects, and accounts for rentals post-production. Companies submit royalty and production reports to ONRR, but ONRR may not collect royalty payments unless BIA requests it. Companies deposit payments into OST- or Native-American-owned lockboxes or mail checks to individual allottees. BIA collects other collections, such as water payments or payments for surface damages.</TableCell>
    </TableRow>
  </TableBody>
</Table>
...
<Link href='/query-data/?dataType=Revenue&landType=Native%20American' linkType='FilterTable'>Query revenue data</Link>
