...
During development and production, the BLM field office performs a number of inspections.  Inspections enforce lease terms and track health, safety, and environmental concerns. When operators extract oil or gas in paying quantities, the lease holder stops paying rent and starts paying <GlossaryTerm>royalties</GlossaryTerm> to ONRR.

</ProcessCard>
<ProcessCard step={5} name={'Decommission and reclaim'}>

Even before the close of an oil and gas operation, operators and lease holders must begin <GlossaryTerm>reclamation</GlossaryTerm>. Before production begins, the operator includes a Reclamation Plan in the Surface Use Plan that must be approved by BLM.
