...
Data about revenue from the extractive industries is bound by rules and regulations in the United States. Companies and governments are accountable to internal and external oversight. This ensures correct reporting and publication of payments.
...
* The [Financial Accounting Standards Board](https://www.fasb.org/) Accounting Standards Codification is the single official source of authoritative, nongovernmental U.S. generally accepted accounting principles (GAAP).
