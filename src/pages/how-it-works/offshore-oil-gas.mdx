...
energy resources and to develop regulations to carry out that authority. Three agencies within DOI — BOEM, BSEE, and ONRR — work together to manage,
regulate, and collect revenue from leased acres across the <GlossaryTerm>Outer Continental Shelf</GlossaryTerm>.

</Box>
</Grid>
<Grid container xs={12} sm={4} >
<Box p={3} border={4} borderBottom={0} borderColor='white'>
...
The lease holder pays annual rent until the operation starts producing oil or gas in paying quantities. At that time, the lease holder stops paying rent and starts paying <GlossaryTerm termKey="royalty">royalties</GlossaryTerm> to ONRR.
...
<ProcessCard name={'Rates and fees'}>

- [Oil and gas rates and fees](/how-it-works/revenues/#oil-gas-rates)

</ProcessCard>
<ProcessCard name={'Learn more'}>

- [Oil and gas leasing on the Outer Continental Shelf (PDF)](http://www.boem.gov/uploadedFiles/BOEM/Oil_and_Gas_Energy_Program/Leasing/5BOEMRE_Leasing101.pdf)
