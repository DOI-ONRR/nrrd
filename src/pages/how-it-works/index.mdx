...
<!-- Import the color palette to use for the background of the grids -->

import palette from '../../js/mui/palette.js'

<Grid container style={{background:palette.blue.light}}>
<Container maxWidth="lg">
<Grid container>
<Grid item xs={12} sm={8} style={{padding:'25px 25px 0px 0px', borderRight: '5px solid white'}}>
...
<Grid container xs={12} sm={4} style={{borderRight: '5px solid white'}}>
<Grid item xs={12} style={{padding:'25px 25px 0px 25px'}}>
...
<p align='center'>
  <HowItWorksRibbonGraphicSvg style={{height:'100px'}}></HowItWorksRibbonGraphicSvg>
</p>
</Grid>
<Grid container xs={12} styleOption='blueGrey' style={{background:palette.blueGrey.default, padding:'25px'}}>
