...
If you would like to file a Section 508 related complaint, please submit the complaint in writing to the  [DOI Office of Diversity, Inclusion and Civil Rights <OpenInNewIcon style={{ fontSize: 20 }} />](https://doi.gov/pmb/eeo) at the following address:  
<br />
...
The ODICR will apply the complaint procedures outlined in  [43 CFR Part 17, Subpart E <OpenInNewIcon style={{ fontSize: 20 }} />](https://www.govinfo.gov/app/details/CFR-2004-title43-vol1/CFR-2004-title43-vol1-part17), which are established to implement Section 504 for resolving allegations of discrimination in a Federally conducted program or activity.
<br />

If you would like to file a Section 508-related complaint, please contact the DOI Section 508 Program via email at  [section508@ios.doi.gov](mailto:section508@ios.doi.gov) or phone (202) 219-0963.
<br />

If you have comments or questions related to the DOI Section 508 Program, please contact the DOI Section 508 Program Coordinator via email at  [section508@ios.doi.gov](mailto:section508@ios.doi.gov) or phone (202) 219-0963. For comments or questions regarding bureau/office Section 508 programs, please contact the  [Bureau/Office Section 508 Coordinator <OpenInNewIcon style={{ fontSize: 20 }} />](https://doi.gov/ocio/section508-contacts).
<br />

## Limitations and alternatives

Despite our best efforts to ensure accessibility of this website, there may be some limitations. Below is a description of known limiataions and potential solutions. Please [contact us](mailto:nrrd@onrr.gov) if you observe an issue not listed below.
<br />

Known limitions for Natural Resources Revenue Data:
...
- If the user needs filtered data and cannot access those functions, they can contact us with their request.
...
The  [DOI Section 508 Program <OpenInNewIcon style={{ fontSize: 20 }} />](https://doi.gov/ocio/section508) manages and oversees the implementation of Section 508 of the Rehabilitation Act of 1973 and ensures information and communication technologies developed, procured, maintained and used by DOI is accessible to everyone. 
<br />
...
The  [ACCESS Center <OpenInNewIcon style={{ fontSize: 20 }} />](https://doi.gov/accommodations), (formerly the Assisted Technology Center or ATC) is a resource center that offers consultation, information, advice and demonstration of assistive technology, safety, and accommodation solutions to increase workplace accessibility and safety for all employees.
<br />

### Disability

[DOI's Office of Diversity, Inclusion and Civil Rights <OpenInNewIcon style={{ fontSize: 20 }} />](https://doi.gov/pmb/eeo/) provides information on civil rights and equal opportunity programs including  [disability-related topics <OpenInNewIcon style={{ fontSize: 20 }} />](https://doi.gov/pmb/eeo/Public-Civil-Rights), and  [instructions for reasonable accommodations <OpenInNewIcon style={{ fontSize: 20 }} />](https://www.doi.gov/pmb/eeo/disability-and-religious-accommodations).
<br />
