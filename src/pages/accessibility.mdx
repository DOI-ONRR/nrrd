...
DOI's [Office of Diversity, Inclusion and Civil Rights <OpenInNewIcon style={{ fontSize: 20 }} />](https://www.doi.gov/pmb/eeo/) provides information on civil rights and equal opportunity programs including [disability-related topics <OpenInNewIcon style={{ fontSize: 20 }} />](https://www.doi.gov/pmb/eeo/Public-Civil-Rights).
<br />
