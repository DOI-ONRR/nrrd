...
--
-- Name: download_monthly_revenue; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.download_monthly_revenue AS
...
ALTER TABLE public.download_monthly_revenue OWNER TO postgres;
