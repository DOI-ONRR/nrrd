...
--
-- Name: download_fiscal_year_revenue; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.download_fiscal_year_revenue AS
...
ALTER TABLE public.download_fiscal_year_revenue OWNER TO postgres;
