...
--
-- Name: total_monthly_fiscal_disbursement; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.total_monthly_fiscal_disbursement AS
 SELECT period.period,
  ...
  WHERE (((period.period)::text = 'Monthly'::text) AND (period.fiscal_year > ( SELECT max((period_1.fiscal_year - 3)) AS max
...
ALTER TABLE public.total_monthly_fiscal_disbursement OWNER TO postgres;
