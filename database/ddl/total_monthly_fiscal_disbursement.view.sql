   ...
   FROM ( SELECT period.period,
       ...
       CASE
        ...
        END AS sort_order,
          ...
          GROUP BY period.period, period.fiscal_year, period.fiscal_month, period.month_long, period.period_date, location.land_class, location.land_category, commodity.source
) a
