...
UNION
 SELECT _mview_location_qtr.g1,
    ...
    _mview_location_qtr.county AS county_name,
    _mview_location_qtr.county_name AS state_offshore_name,
    _mview_location_qtr.state_offshore_name AS county,
...
UNION
 SELECT _mview_commodity_qtr.g1,
    ...
    _mview_commodity_qtr.county AS county_name,
    _mview_commodity_qtr.county_name AS state_offshore_name,
    _mview_commodity_qtr.state_offshore_name AS county,
...
UNION
 SELECT _mview_fund_location_qtr.g1,
    ...
    _mview_fund_location_qtr.county AS county_name,
    _mview_fund_location_qtr.county_name AS state_offshore_name,
    _mview_fund_location_qtr.state_offshore_name AS county,
...
UNION
 SELECT _mview_fund_commodity_qtr.g1,
    ...
    _mview_fund_commodity_qtr.county AS county_name,
    _mview_fund_commodity_qtr.county_name AS state_offshore_name,
    _mview_fund_commodity_qtr.state_offshore_name AS county,
...
UNION
 SELECT _mview_location_commodity_qtr.g1,
    ...
    _mview_location_commodity_qtr.county AS county_name,
    _mview_location_commodity_qtr.county_name AS state_offshore_name,
    _mview_location_commodity_qtr.state_offshore_name AS county,
...
UNION
 SELECT _mview_fund_location_commodity_qtr.g1,
    ...
    _mview_fund_location_commodity_qtr.county AS county_name,
    _mview_fund_location_commodity_qtr.county_name AS state_offshore_name,
    _mview_fund_location_commodity_qtr.state_offshore_name AS county,
