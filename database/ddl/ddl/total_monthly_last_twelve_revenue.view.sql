...
--
-- Name: total_monthly_last_twelve_revenue; Type: VIEW; Schema: public; Owner: postgres
--

CREATE VIEW public.total_monthly_last_twelve_revenue AS
...
ALTER TABLE public.total_monthly_last_twelve_revenue OWNER TO postgres;
