 ...
 SELECT a.period,
   ...
   FROM ( SELECT period.period,
        ...
        END AS sort_order,
          ...
          GROUP BY period.period, period.calendar_year, period.month, period.month_long, period.period_date, location.land_category,location.land_class, commodity.source
          ) a 
