...
update federal_revenue_by_company set commodity=REPLACE(commodity, ' ', '1spc1') ;
update federal_revenue_by_company set commodity=REPLACE(commodity, '-', '1dsh1') ;
update federal_revenue_by_company set commodity=REPLACE(commodity, '/', '1slsh1') ;
update federal_revenue_by_company set commodity=REPLACE(commodity, '(', '1oprn1') ;
update federal_revenue_by_company set commodity=REPLACE(commodity, ')', '1cprn1') ;
update federal_revenue_by_company set commodity=initcap(commodity) ;
update federal_revenue_by_company set commodity=REPLACE(commodity, '1dsh1','-') ;
update federal_revenue_by_company set commodity=REPLACE(commodity, '1slsh1', '/') ;
update federal_revenue_by_company set commodity=REPLACE(commodity, '1oprn1','(') ;
update federal_revenue_by_company set commodity=REPLACE(commodity, '1cprn1', ')') ;
update federal_revenue_by_company set commodity=REPLACE(commodity, '1spc1', ' ') ;
update federal_revenue_by_company set commodity=REPLACE(commodity, 'N\a', 'N\A');
update federal_revenue_by_company set commodity=REPLACE(commodity, 'N\a ', 'N\A');
