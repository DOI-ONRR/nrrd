...
update fiscal_year_production_elt set offshore_region='Alaska' where offshore_region='Offshore Alaska';
update fiscal_year_production_elt set offshore_region='Pacific' where offshore_region='Offshore Pacific';
update fiscal_year_production_elt set offshore_region='Atlantic' where offshore_region='Offshore Atlantic';
update fiscal_year_production_elt set offshore_region='Gulf of Mexico', fips_code='GMR', county=null, state=null where offshore_region='Offshore Gulf';
